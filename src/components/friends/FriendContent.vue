<template>
    <div class="text-white flex flex-col w-full">
        <div class="flex border-2 border-darkblue/80 w-full px-2 lg:px-8 py-2">
        ...
        <div class="flex flex-col w-full lg:w-2/3 p-8">
            ...
            <div v-if="option == 3">
                ...
                <div class="flex flex-col w-full mt-4">
                    <FriendInvitation 
                        v-for="friendship in filteredPending" 
                        :key="friendship.id"
                        :id="friendship.id"
    ...
    computed: {
        ...
        filteredPending() {
            return this.pendingList.filter(item =>
                item.friend.name.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
                item.friend.username.toLowerCase().includes(this.searchQuery.toLowerCase())
            );
        },
